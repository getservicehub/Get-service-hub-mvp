  ...
  useEffect(() => {
    ...
    <main className="min-h-screen bg-bg text-white pt-[100px] pb-16 px-5">
      <div className="max-w-[1140px] mx-auto">
        ...
        <p className="text-base text-muted2 max-w-[540px] mb-10">Verified, reviewed, and ready to help. These pros have earned their reputation.</p>
        ...
        {!loading && services.length === 0 && (
          <div className="text-center py-16">
            ...
            <div className="text-muted2 text-sm">No featured pros yet.</div>
          </div>
        )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {services.map((s) => {
            ...
            return (
              <div key={s.id} className="bg-card border border-white/[.08] rounded-[20px] overflow-hidden hover:border-white/20 hover:-translate-y-1 transition-all">
