...
import type { ServiceCard } from "@/lib/services/queries";
...
export default function ServiceDetailClient({ service, initialReviews, serviceId }: Props) {
  ...
  const loadUserContext = async () => {
    ...
    if (currentUserId) {
      setHasReviewed(reviews.some((r) => r.client_id === currentUserId));
    }
