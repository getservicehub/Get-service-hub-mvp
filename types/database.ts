export type SpecialtyRow = {
  ...
  category_id: "licensed" | "portfolio";
  icon: string;
...
export type ProfessionalRow = {
  ...
  years_experience_value: number | null;
...
export type ProfessionalStatsRow = {
  ...
  verified_service_reviews: number;
  professional_references: number;
  imported_external_reviews: number;
  unverified_comments: number;
};
